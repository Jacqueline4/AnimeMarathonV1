...
namespace AnimeMarathonV1.Controllers
{
    ...
    public class AnimeController : ControllerBase
    {
        ...
        public AnimeController( IAnimeService animeService, IBaseServices<UsersAnimeDTO,UsersAnimes> baseServices)
        {
        ...
        {  
            return await animeService.GetAnimeFilteredGeneric(data);
        }
        ...
        public async Task<IEnumerable<AnimeDTO>> GetAnimes(string animeName)
        {
            ...
            return await animeService.GetAnimeByName(animeName); 
        }
        /// <summary>
        ...
        {
            return await animeService.GetCommentsByAnimeId(animeId);
        }
        /// <summary>
        ...
        {
            return await animeService.Create(animeViewModel);
        }
        /// <summary>
        ...
        {
            return await baseServices.Update(animeViewModel);
